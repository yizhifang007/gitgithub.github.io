window.skins=window.skins||{};
	...
	function lobbyComponentSkin() {
		...
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this._InputComponent1_i(),this._Label1_i(),this._Label2_i(),this._InputComponent2_i()];
	}
	...
	_proto._InputComponent1_i = function () {
	...
	_proto._InputComponent2_i = function () {
		var t = new InputComponent();
		t.height = 20;
		t.width = 20;
		t.x = 240;
